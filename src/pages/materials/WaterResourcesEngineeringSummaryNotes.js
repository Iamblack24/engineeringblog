...
const WaterResourcesEngineeringSummaryNotes = () => {
  return (
    <div className="container">
      <h1 className="header">Water Resources Engineering Summary Notes</h1>
      <p className="text">Summarized notes covering the essential topics in water resources engineering.</p>

      <section className="section">
        <h2 className="section-title">1. Introduction to Water Resources Engineering</h2>
        <p className="text">
      ...
      <section className="section">
        <h2 className="section-title">2. Hydrology</h2>
        <p className="text">
        ...
        <p className="text"><strong>Runoff Coefficient (C):</strong> C = Q / P</p>
        <p className="text"><strong>Hydraulic Radius (R):</strong> R = A / P</p>
      </section>

      <section className="section">
        <h2 className="section-title">3. Hydraulics</h2>
        <p className="text">
      ...
      <section className="section">
        <h2 className="section-title">4. Water Supply Systems</h2>
        <p className="text">
      ...
      <section className="section">
        <h2 className="section-title">5. Wastewater Management</h2>
        <p className="text">
        ...
        <h3 className="section-title">Key Processes:</h3>
        <ul className="text">
      ...
      <section className="section">
        <h2 className="section-title">6. Flood Control</h2>
        <p className="text">
        ...
        <h3 className="section-title">Key Measures:</h3>
        <ul className="text">
      ...
      <section className="section">
        <h2 className="section-title">7. Irrigation Systems</h2>
        <p className="text">
        ...
        <h3 className="section-title">Key Methods:</h3>
        <ul className="text">
      ...
      <section className="section">
        <h2 className="section-title">8. Groundwater Management</h2>
        <p className="text">
      ...
      <section className="section">
        <h2 className="section-title">9. Environmental Impact Assessment (EIA) in Water Resources</h2>
        <p className="text">
        ...
        <h3 className="section-title">Key Steps:</h3>
        <ul className="text">
          <li>Screening</li>
          <li>Scoping</li>
      ...
      <section className="section">
        <h2 className="section-title">10. Climate Change and Water Resources</h2>
        <p className="text">
        ...
        <h3 className="section-title">Key Impacts:</h3>
        <ul className="text">
        ...
        <h3 className="section-title">Adaptive Strategies:</h3>
        <ul className="text">
